namespace System.Collections.ObjectModel
{
    ...
    public class RangeObservableCollection<T> : ObservableCollection<T>
    {
        ...
        private DeferredEventsCollection DeferredEvents { get => _deferredEvents; set => _deferredEvents = value; }
        private DeferredEventsCollection DeferredEvents1 { get => _deferredEvents; set => _deferredEvents = value; }
